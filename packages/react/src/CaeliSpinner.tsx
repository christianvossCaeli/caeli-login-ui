...
import type { CaeliSpinnerProps } from './types';

/**
 * CaeliSpinner - Animated Caeli logo with breathing effect
 *
 * Displays the Caeli wind logo with a pulsing glow effect
 * and glass-morphism background circle.
 */
export const CaeliSpinner = memo(function CaeliSpinner({
  size = 70,
}: CaeliSpinnerProps) {
  return (
    <div className="spinner-container">
      {/* Glow effect */}
      <div className="spinner-glow" aria-hidden="true" />
      {/* Glass background circle */}
      <div className="glass-circle" aria-hidden="true" />
      {/* Animated SVG Spinner */}
      <svg
        className="caeli-spinner"
        width={size}
        height={size}
        viewBox="0 0 32 32"
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
        aria-label="Caeli Logo"
        role="img"
      >
        {/* Top vertical bar */}
        <path
          className="spinner-ray"
          d="M17.3103 0.134766H14.7295V12.8374H17.3103V0.134766Z"
          fill="rgb(222, 238, 198)"
